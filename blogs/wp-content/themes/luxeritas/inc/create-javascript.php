...
var LuxeProgressBar = function () {
	...
	,   i = document
	,   e = i.documentElement.clientHeight
	,   n = ((r.scrollY || r.pageYOffset) / (i.body.clientHeight - e)) * 100
	,   u = i.getElementById("gnav-progress");
...
SCRIPT;
			...
			/* スクロールプログレスバーのリスナー */
			$ret .= <<< SCRIPT
window.addEventListener("scroll", LuxeProgressBar, !1), window.addEventListener("load", LuxeProgressBar, !1), window.addEventListener("resize", LuxeProgressBar, !1);
SCRIPT;
		}
