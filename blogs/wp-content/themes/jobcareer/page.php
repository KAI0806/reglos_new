...
/* For again login if payment is paypal */
if(isset($_REQUEST['custom']) && $_REQUEST['custom'] != ''){
	$user_id_for_againlogin = get_post_meta($_REQUEST['custom'], 'cs_transaction_user', true);
	if($user_id_for_againlogin != ''){
		wp_set_current_user($user_id_for_againlogin);
		wp_set_auth_cookie($user_id_for_againlogin);
	}
	wp_redirect(get_home_url().'/employer-account/?payment_status_paypal=success');
	exit;
}
        ...
        if (isset($count)) {
                                ...
                                <div class="row">
                                    ...
                                    if (isset($cs_page_upcoming) && $cs_page_upcoming == "on") {
                                        ...
                                        if (isset($image_url) && $image_url != '') {
                                            ?>
                                            <a  href="<?php echo esc_url($image_url); ?>" data-rel="prettyPhoto" data-title="image">
                                                <figure>
                                                    <div class="page-featured-image">
                                                        <img class="img-thumbnail cs-page-thumbnail" title="image_url" alt="thumbnail" data-src="" src="<?php echo esc_url($image_url); ?>">
                                                    </div>
                                                </figure>
                                            </a>
                                            <?php
            ...
            if (isset($jobcareer_xmlObject->column_container)) {
                ...
                foreach ($jobcareer_xmlObject->column_container as $column_container) {
                            ...
                            if ($url['host'] == cs_get_server_data('SERVER_NAME')) {
                                ...
                                <script>
                                    jQuery(document).ready(function ($) {
                                        document.getElementById("player<?php echo jobcareer_special_char($rand_player_id); ?>").controls = false;
                                    });
                                </script>
                                <?php
                                        ...
                                        if ($string_exists === false) {
                                            ...
                                            if ($cs_section_video_mute == 'yes') {
                                                ...
                                                <script>
                                                    ...
                                                    var freme_api = '<?php echo jobcareer_special_char($fram_str . '_api'); ?>';
                    ...
                    ?>
                    <!-- Page Section -->
                    <div <?php echo jobcareer_special_char($cs_section_css_id); ?> class="page-section<?php echo jobcareer_special_char($custom_bacground_option_class);
                echo jobcareer_special_char($class_for_aviation);
                    ?>  cs-page-sec-<?php echo absint($cs_section_rand_id) ?> <?php echo sanitize_html_class($parallax_class); ?>" <?php echo jobcareer_special_char($parallax_data_type); ?>  <?php //echo jobcareer_special_char($section_style_element);                                 ?> >
                                                                                   <?php
                                                                                   if (isset($cs_section_background_option) && $cs_section_background_option == 'section_background_video') {
                                                                                       $cs_section_video_url = $jobcareer_column_atts->cs_section_video_url;
                                                                                       if (!empty($cs_section_video_url)) {
