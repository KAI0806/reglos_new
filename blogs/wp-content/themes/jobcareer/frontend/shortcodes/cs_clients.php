    ...
    function cs_clients_item_shortcode($atts, $content = "") {
        ...
        if ($cs_client_style == 'simple' || $cs_client_style == 'modern' || $cs_client_style == 'fancy' || $cs_client_style == 'aviation') {
            ...
            if ($classes == 'has-border') {
                ...
                $html .= '<div class="' . $classes . '"><a href="' . esc_url($cs_website_url) . '"><img src="' . esc_url($cs_client_logo) . '" alt="image"/></a></div>';
                $html .= '</div>';
            }
            if ($cs_client_style == 'aviation') {
                $html .= '<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12"><a href="' . esc_url($cs_website_url) . '"><img src="' . esc_url($cs_client_logo) . '" alt="image"/></a></div>';
            }
            else {
                $html .= '<div class="col-lg-2 col-md-2 col-sm-4 col-xs-12 ' . $classes . '"><a href="' . esc_url($cs_website_url) . '"><img src="' . esc_url($cs_client_logo) . '" alt="image"/></a></div>';
            }
        } else {
            $html .= '<li class="col-lg-2 col-md-2 col-sm-4 col-xs-12"><a href="' . esc_url($cs_website_url) . '"><img src="' . esc_url($cs_client_logo) . '" alt="image"/></a></li>';
        }
        return $html;
    }
