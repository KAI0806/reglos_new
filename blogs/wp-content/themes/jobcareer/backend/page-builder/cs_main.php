...
if (!function_exists('jobcareer_page_bulider_add')) {
    ...
    if (function_exists('cs_metaboxes_adding')) {
        cs_metaboxes_adding('jobcareer_page_bulider_add');
    }

    function jobcareer_page_bulider_add() {
        if (function_exists('cs_meta_box')) {
            cs_meta_box('id_page_builder', esc_html__('CS Page Builder', 'jobcareer'), 'jobcareer_page_bulider', 'page', 'normal', 'high');
        }
    }
                            ...
                            for ($j = 1; $j <= $a; $j ++) {
                                ...
                                // Job Post
                                    ...
                                    if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                        ...
                                        $shortcode .= apply_filters('jobhunt_post_job_professions_element_fields', $cs_counter_jobs_search, $_POST);
...
//                                                }
                                ...
                                // Multiple services
                                    ...
                                    if (isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode') {
                                        ...
                                        $shortcode .= apply_filters('jobhunt_save_the_professions_inelement', $cs_counter_candidate, $_POST);
