                    ...
                    <form id="frm" method="post">
                        ...
                        <div class="col1">
                            <nav class="admin-navigtion">
                                ...
                                <ul>
                                    <?php echo jobcareer_special_char($return[1], true); ?>
                                </ul>
                            </nav>
                        </div>
                        <div class="col2">
                            <?php echo jobcareer_special_char($return[0], true); /* Settings */ ?>
                        </div>
                </div>
                        <div class="clear"></div>
                        <div class="footer">
...
//            );
        ...
        $jobcareer_sett_options[] = array( "name" => esc_html__("Copyright Text", 'jobcareer'),
            ...
            "id" => "cs_copy_right",
            "std" => "&copy; " . esc_html__('2020 Jobhunt Name All rights reserved. Design by', 'jobcareer') . " <a class='cscolor' href='#'>" . esc_html__('Chimp Studio', 'jobcareer') . "</a>",
            "type" => "textarea"
        );
        ...
        $jobcareer_sett_options[] = array( "name" => esc_html__("Marketplace Token", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("Enter the Envato API Personal Token.", 'jobcareer'),
            "id" => "cs_marketplace_token",
            "std" => "",
            "type" => "text" );
        $jobcareer_sett_options[] = array( "name" => esc_html__("Item ID", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("Enter the Envato Item ID.", 'jobcareer'),
            "id" => "cs_item_id",
            "std" => "",
            "type" => "text" );
