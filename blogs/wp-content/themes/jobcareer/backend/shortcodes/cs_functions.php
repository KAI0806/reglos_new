        ...
        if ( isset($_POST['shortcode_element']) && $_POST['shortcode_element'] ) {
            if ( $_POST['shortcode_element'] == 'accordions' ) {
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp' id="cs_infobox_<?php echo intval($rand_id); ?>">
                    ...
                    <?php
                    $cs_list_item = isset($cs_list_item) ? $cs_list_item : '';
                    $cs_opt_array = array(
                    ...
                    $jobcareer_html_fields->cs_text_field($cs_opt_array);
                    $display = (isset($cs_list_type) && $cs_list_type == 'icon') ? 'block' : 'none';
                    echo '<div class="list_icon_div" style=" display:' . $display . ' ">';
                    ?>
                    <div class="icon_fields">
                        <?php
                            $name = isset($name) ? $name : '';
                            $cs_counter = isset($cs_counter) ? $cs_counter : '';
                        ?>
                        <div class="form-elements" id="cs_infobox_<?php echo esc_attr($name . $cs_counter); ?>">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                <?php
                                $cs_list_icon = isset($cs_list_icon) ? $cs_list_icon : '';
                                jobcareer_fontawsome_icons_box($cs_list_icon, $rand_id, 'cs_list_icon'); ?>
                            </div>
                        </div>

                        <?php
                        $cs_list_item_icon_color = isset($cs_list_item_icon_color) ? $cs_list_item_icon_color : '';
                        $cs_opt_array = array(
                        ...
                        $jobcareer_html_fields->cs_text_field($cs_opt_array);
                        $cs_list_item_icon_bg_color = isset($cs_list_item_icon_bg_color) ? $cs_list_item_icon_bg_color : '';
                        $cs_opt_array = array(
